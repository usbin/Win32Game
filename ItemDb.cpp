...
void ItemDb::Init()
{
	...
	parsnip_seed->set_scale(Vector2{ 48, 96 });
	...
	ItemSprite* hoe_profile_sprite = DEBUG_NEW ItemSprite();
	hoe_profile_sprite->QuickSet(tool_texture, hoe, Vector2{ 0, 32 }, Vector2{ 16, 16 });
	hoe->profile_sprite_ = hoe_profile_sprite;
	...
	ItemSprite* watering_pot_profile_sprite = DEBUG_NEW ItemSprite();
	watering_pot_profile_sprite->QuickSet(tool_texture, watering_pot, Vector2{ 0, 608 }, Vector2{ 16, 16 });
	watering_pot->profile_sprite_ = watering_pot_profile_sprite;
	...
	ItemSprite* pickaxe_profile_sprite = DEBUG_NEW ItemSprite();
	pickaxe_profile_sprite->QuickSet(tool_texture, pickaxe, Vector2{ 0, 224 }, Vector2{ 16, 16 });
	pickaxe->profile_sprite_ = pickaxe_profile_sprite;
	...
	ItemSprite* axe_profile_sprite = DEBUG_NEW ItemSprite();
	axe_profile_sprite->set_texture(tool_texture);
	axe_profile_sprite->set_base_pos(Vector2{ 0, 416 });
	axe_profile_sprite->set_scale(Vector2{ 16, 16 });
	axe->profile_sprite_ = axe_profile_sprite;
	...
	ItemSprite* stone_profile_sprite = DEBUG_NEW ItemSprite();
	stone_profile_sprite->set_texture(forage_texture);
	stone_profile_sprite->set_base_pos(Vector2{ 136, 200 });
	stone_profile_sprite->set_scale(Vector2{ 16, 16 });
	stone->profile_sprite_ = stone_profile_sprite;
	stone_profile_sprite->set_owner(stone);
	...
	ItemSprite* weed_profile_sprite = DEBUG_NEW ItemSprite();
	weed_profile_sprite->set_texture(forage_texture);
	weed_profile_sprite->set_base_pos(Vector2{ 32, 192 });
	weed_profile_sprite->set_scale(Vector2{ 32, 32 });
	weed->profile_sprite_ = weed_profile_sprite;
	weed_profile_sprite->set_owner(weed);
	...
	ItemSprite* wood_profile_sprite = DEBUG_NEW ItemSprite();
	wood_profile_sprite->set_texture(forage_texture);
	wood_profile_sprite->set_base_pos(Vector2{ 70, 199 });
	wood_profile_sprite->set_scale(Vector2{ 16, 16 });
	wood->profile_sprite_ = wood_profile_sprite;
	wood_profile_sprite->set_owner(wood);
	ItemSprite* parsnip_seed_profile_sprite = DEBUG_NEW ItemSprite();
	parsnip_seed_profile_sprite->set_texture(crop_texture);
	parsnip_seed_profile_sprite->set_base_pos(Vector2{ 0, 16 });
	parsnip_seed_profile_sprite->set_scale(Vector2{ 16, 16 });
	parsnip_seed->profile_sprite_ = parsnip_seed_profile_sprite;
	parsnip_seed_profile_sprite->set_owner(parsnip_seed);
	ItemSprite* parsnip_seed_sprite = DEBUG_NEW ItemSprite();
	parsnip_seed_sprite->set_texture(crop_texture);
	parsnip_seed_sprite->set_base_pos(Vector2{ 0, 8 });
	parsnip_seed_sprite->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite0->set_base_pos(Vector2{ 0, 8 });
	parsnip_seed_sprite0->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite1->set_base_pos(Vector2{ 16, 8 });
	parsnip_seed_sprite1->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite2->set_base_pos(Vector2{ 32, 8 });
	parsnip_seed_sprite2->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite3->set_base_pos(Vector2{ 48, 8 });
	parsnip_seed_sprite3->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite4->set_base_pos(Vector2{ 64, 8 });
	parsnip_seed_sprite4->set_scale(Vector2{ 16, 32 });
	...
	parsnip_seed_sprite5->set_base_pos(Vector2{ 80, 8 });
	parsnip_seed_sprite5->set_scale(Vector2{ 16, 32 });
	...
	ItemSprite* parsnip_profile_sprite = DEBUG_NEW ItemSprite();
	parsnip_profile_sprite->set_texture(crop_texture);
	parsnip_profile_sprite->set_base_pos(Vector2{ 96, 8 });
	parsnip_profile_sprite->set_scale(Vector2{ 16, 16 });
	parsnip_profile_sprite->set_owner(parsnip);
	parsnip->profile_sprite_ = parsnip_profile_sprite;
